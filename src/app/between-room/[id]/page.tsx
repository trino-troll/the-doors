  ...
  return (
    <div>
      <div className="flex gap-3 mb-2">
        ...
        <h2 className="text-lg lg:text-2xl font-semibold">{door.name}</h2>
      </div>
      ...
      <table className="mt-3">
        <tbody className="border-2">
          <tr className="border">
            ...
            <td className="px-1 font-semibold align-top">{door.factory}</td>
          </tr>
          <tr className="border">
            <td className="px-1 border-r align-top">Материал</td>
            <td className="px-1 font-semibold align-top">{door.materials}</td>
          </tr>
          <tr className="border">
            <td className="px-1 border-r align-top">Доступные цвета:</td>
          ...
          <tr className="border">
            <td className="px-1 border-r align-top">Внутреннее наполнение:</td>
            <td className="px-1 font-semibold align-top">
              {door.innerFilling}
            </td>
          </tr>
              ...
              {door.comment && door.comment.length > 0 ? (
                <ul>
                  {door.comment.split("\n").map((line, i) => (
                    <li
                      className={clsx({
                        "text-red-600": line.includes("Нестандарт"),
                      })}
                      key={line + i}
                    >
                      {line}
      ...
      <table>
        ...
        <tbody>
          <tr className="border">
            <td className="px-2 border-r text-center">{door.is600}</td>
            <td className="px-2 border-r text-center">{door.is700}</td>
            <td className="px-2 border-r text-center">{door.is800}</td>
