            ...
            >
              ...
              <div className="flex flex-col gap-1">
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    setEditDoor({ ...editDoor, description: e.target.value })
                  }
                />
              </div>
              ...
              <div className="flex flex-col gap-1">
                ...
                <input
                  ...
                  value={editDoor.size}
                  onChange={(e) =>
                    setEditDoor({ ...editDoor, size: e.target.value })
                  }
                />
              </div>
              ...
              <div className="flex flex-col gap-1">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setEditDoor({
                      ...editDoor,
                      opening: e.target.value as Door["opening"],
                    })
                  }
                >
              ...
              <div className="flex flex-col gap-1">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setEditDoor({ ...editDoor, color: e.target.value })
                  }
                />
              </div>
